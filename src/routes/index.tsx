...
const projects = [
  ...
  { img: pNexa, title: "NEXA ⚡ — AI-Powered Electronics Engineering Agent", desc: "Developed an agentic AI platform featuring a 7-agent swarm and a deterministic Physics Validation Engine to autonomously design, simulate, and debug electronic circuits without LLM hallucinations.", tags: ["FastAPI", "Gemini 3", "Multi-Agent AI", "React", "Computer Vision"] },
